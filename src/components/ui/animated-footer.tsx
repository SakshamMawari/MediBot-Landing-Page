...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      ref={footerRef}
      className="bg-background text-foreground relative flex flex-col w-full h-full justify-between lg:h-screen select-none"
    >
      <div className="container mx-auto flex flex-col items-center justify-center w-full gap-6 pb-0 pt-8 px-4 text-center min-h-[60vh]">
